...
@app.get("/api/worker/related-occupations")
def api_worker_related_occupations():
    occupation_code = (request.args.get("occupation") or "").strip()
...
def api_worker_transition_evidence():
