...
from gvai.postlabor.sources.oews_wage_snapshot import (
    build_multi_area_wage_employment_snapshot,
...
DEFAULT_OUTPUT = Path(
    "gvai/postlabor/snapshots/oews/wage_index.json"
)
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Build an official multi-area OEWS 2025 median wage snapshot."
    )
    ...
    try:
        snapshot = build_multi_area_wage_employment_snapshot(
